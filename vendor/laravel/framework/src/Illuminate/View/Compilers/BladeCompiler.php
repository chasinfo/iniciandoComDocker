...
class BladeCompiler extends Compiler implements CompilerInterface
{
    ...
    /**
     * Array of footer lines to be added to app.
     *
     * @var array
     */
    protected $footer = [];
    ...
    /**
     * Array to temporary store the raw blocks found in the app.
     *
     * @var array
     */
    protected $rawBlocks = [];
    ...
    /**
     * Compile the given Blade app contents.
     *
     * @param  string  $value
     * @return string
     */
    public function compileString($value)
    {
        ...
        // app as the correctly rendered PHP that can be rendered natively.
        ...
        // If there are any footer lines that need to get added to a app we will
        // add them here at the end of the app. This gets used mainly for the
        // app inheritance via the extends keyword that should be appended.
