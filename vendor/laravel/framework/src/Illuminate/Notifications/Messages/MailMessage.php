...
class MailMessage extends SimpleMessage implements Renderable
{
    ...
    /**
     * The Markdown app to render (if applicable).
     *
     * @var string|null
     */
    ...
    /**
     * Set the Markdown app for the notification.
     *
     * @param  string  $view
     * @param  array  $data
     * @return $this
    ...
    /**
     * Set the theme to use with the Markdown app.
     *
     * @param  string  $theme
     * @return $this
     */
