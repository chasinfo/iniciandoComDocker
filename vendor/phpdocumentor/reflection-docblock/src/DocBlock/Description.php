 ...
 * a body app with sprintf-style placeholders together with formatted tags in order to reconstitute a complete
 ...
 *
 * The description factory will interpret the given body and create a body app and list of tags from them, and pass
 ...
 *
 * If you do not want to use the DescriptionFactory you can pass a body app and tag listing like this:
 *
...
class Description
{
    ...
    /**
     * Initializes a Description with its body (app) and a listing of the tags used in the body app.
     *
     * @param Tag[] $tags
     */
