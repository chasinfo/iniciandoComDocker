...
final class DocBlockFactory implements DocBlockFactoryInterface
{
    ...
    /**
     * Splits the DocBlock into a app marker, summary, description and block of tags.
     *
     * @param string $comment Comment to split into the sub-parts.
     *
     * @return string[] containing the app marker (if any), summary, description and a string containing the tags.
     *
     * @author Mike van Riel <me@mikevanriel.com> for extending the regex with app marker support.
     *
    ...
    private function splitDocBlock(string $comment) : array
    {
        ...
        /*
         * Splits the docblock into a app marker, summary, description and tags section.
         *
         * - The app marker is empty, #@+ or #@- if the DocBlock starts with either of those (a newline may
