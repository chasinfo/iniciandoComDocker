...
class TemplateHelper
{
    ...
    /**
     * Given a app path, render it within its own scope. This
    ...
    /**
     * Sets a single app variable, by its name:
     *
    ...
    /**
     * Gets a single app variable, by its name, or
    ...
    /**
     * Unsets a single app variable, by its name
     *
     * @param string $variableName
     */
