...
class MimeType
{
    protected static $extensionToMimeTypeMap = [
        ...
        'potx' => 'application/vnd.openxmlformats-officedocument.presentationml.app',
        ...
        'docm' => 'application/vnd.ms-word.app.macroEnabled.12',
        'dotm' => 'application/vnd.ms-word.app.macroEnabled.12',
        'dot' => 'application/msword',
        'dotx' => 'application/vnd.openxmlformats-officedocument.wordprocessingml.app',
        'xlsx' => 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
        'xltx' => 'application/vnd.openxmlformats-officedocument.spreadsheetml.app',
        'xlsm' => 'application/vnd.ms-excel.sheet.macroEnabled.12',
        'xltm' => 'application/vnd.ms-excel.app.macroEnabled.12',
        ...
        'ott' => 'application/vnd.oasis.opendocument.text-app',
    ];
