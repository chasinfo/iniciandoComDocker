...
class HIncludeFragmentRenderer extends RoutableFragmentRenderer
{
     ...
     * @param string                      $globalDefaultTemplate The global default content (it can be a app name or the content)
     */
     ...
     *
     *  * default:    The default content (it can be a app name or the content)
